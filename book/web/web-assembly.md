...
![webassembly-js-engine-00](../assets/webassembly-js-engine-00.png)

随着这种改进的性能，JavaScript 开始被用于意想不到的事情，比如使用Node.js和Electron构建应用程序。

现在 WebAssembly 可能是的另一个转折点。

![webassembly-js-engine-01](../assets/webassembly-js-engine-01.png)
...
在编程中，通常有两种翻译方法将代码翻译成机器语言。你可以使用`解释器`或者`编译器`。
...
![webassembly-js-engine](../assets/webassembly-js-engine.png)
...
![webassembly-js-engine-08](../assets/webassembly-js-engine-08.png)
...
![webassembly-js-engine-02](../assets/webassembly-js-engine-02.png)

浏览器的 JS 引擎有轻微的不同。这里是基于 SpiderMonkey 来讲。
...
![webassembly-js-engine-03](../assets/webassembly-js-engine-03.png)
...
![webassembly-js-engine-04](../assets/webassembly-js-engine-04.png)
...
![webassembly-js-engine-05](../assets/webassembly-js-engine-05.png)
...
![webassembly-js-engine-06](../assets/webassembly-js-engine-06.png)
...
![webassembly-js-engine-07](../assets/webassembly-js-engine-07.png)
...
![webassembly-js-engine-09](../assets/webassembly-js-engine-09.png)
...
![webassembly-js-engine-10](../assets/webassembly-js-engine-10.png)
...
![webassembly-js-engine-11](../assets/webassembly-js-engine-11.png)

那么这个大脑会拿后面的两个块来确定他们所要操作的数。这两个块对应的是寄存器的地址。

![webassembly-js-engine-12](../assets/webassembly-js-engine-12.png)

请注意添加在机器码上面的标注（ADD R1 R2），这使我们更容易了解发生了什么。这就是`汇编`。它被称为符号机器码。这样人类也能看懂机器码的含义。
...
![webassembly-js-engine-16](../assets/webassembly-js-engine-16.png)
...
注意：大多数 WebAssembly 模块开发者使用 C 和 Rust 编写代码，然后编译成 WebAssembly，但是这里有其他创建 WebAssembly 模块的途径。比如，这里有一个实验性工具，他可以帮你使用 TypeScript 创建一个 WebAssembly 模块，你可以在这里直接编辑WebAssembly。
...
![webassembly-js-engine-17](../assets/webassembly-js-engine-17.png)
...
![webassembly-js-engine-18](../assets/webassembly-js-engine-18.png)
...
![webassembly-js-engine-19](../assets/webassembly-js-engine-19.png)

任何人开发的 WebAssembly 模块很可能被 Web 开发人员使用并为该模块创建一个的装饰器。这样，您当做用户来使用这个模块就不需要考虑内存管理的事情了。

我已经在另一篇文章中解释了更多 [关于使用WebAssembly模块的内容](https://hacks.mozilla.org/2017/02/creating-and-working-with-webassembly-modules/)。
